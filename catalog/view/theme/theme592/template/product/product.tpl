			...
			<div class="<?php echo $content_right; ?> product_page-right">
				<div class="general_info product-info">
					...
					<div class="rating-section product-rating-status">
						...
						<div class="rating">
							<?php for ($i = 1; $i <= 5; $i++) { ?>
							<?php if ($rating < $i) { ?>
							<span class="fa fa-stack"><i class="fa material-design-bookmark45 mod1 fa-stack-1x"></i></span>
							<?php } else { ?>
							<span class="fa fa-stack"><i class="fa material-design-bookmark45 fa-stack-1x"></i><i class="fa material-design-bookmark45 fa-stack-1x"></i></span>
							<?php } ?>
							<?php } ?>
							&nbsp;
							&nbsp;
				...
				<div id="product">
							...
							<?php foreach ($options as $option) { ?>
								...
								<?php if ($option['type'] == 'file') { ?>
									<div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
										<label class="control-label col-sm-4"><?php echo $option['name']; ?></label>
										<div class="col-sm-8">
											<button type="button" id="button-upload<?php echo $option['product_option_id']; ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-block btn-default"><i class="fa fa-upload"></i><span> <?php echo $button_upload; ?></span></button>
					...
					<div class="form-group form-horizontal">
						...
						<button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn-mod product-btn-add"><span><?php echo $button_cart; ?></span></button>
						<?php  echo $fastorder;?>
					</div>
						...
						<div class="form-group">
							<div class="col-sm-9 col-sm-offset-3"> 
								...
								<div class="pull-right">
									<button type="button" id="button-review" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><span><?php echo $button_continue; ?></span></button>
								</div>
							</div>
