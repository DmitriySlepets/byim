	...
	<div class="table-responsive">
	  <table class="table table-bordered">
		...
		<tr>
		  <td></td>
		  <?php foreach ($products as $product) { ?>
		  <td><button type="button" class="btn btn-primary btn-block" onclick="cart.add('<?php echo $product['product_id']; ?>');"><span><?php echo $button_cart; ?></span> </button>
			<a href="<?php echo $product['remove']; ?>" class="btn btn-danger btn-block"><span><?php echo $button_remove; ?></span></a></td>
		  <?php } ?>
		</tr>
	  </table>
		</div>
