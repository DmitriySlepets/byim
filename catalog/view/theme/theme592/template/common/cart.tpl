  ...
  <ul class="dropdown-menu pull-right">
	...
	<li>
	  ...
	  <table class="table">
		...
		<tr>
		  ...
		  <td class="text-center"><button type="button" onclick="cart.remove('<?php echo $product['key']; ?>');" title="<?php echo $button_remove; ?>" class="btn btn-danger btn-xs"><i class="material-design-close47"></i></button></td>
		</tr>
		<?php } ?>
	...
	<li>
	  <div>
		...
		<p class="text-right">
			<a class="btn btn-primary" href="<?php echo $cart; ?>"><!--<i class="fa fa-shopping-cart"></i>--> <span><?php echo $text_cart; ?></span></a>
			<a class="btn btn-primary" href="<?php echo $checkout; ?>"><!--<i class="fa fa-share"></i>--> <span><?php echo $text_checkout; ?></span></a></p>
	  </div>
	</li>
	<?php } else { ?>
	<li>
