	...
	<div class="box-content">
		...
		<div class="product-layout col-lg-4 col-md-4 col-sm-4 col-xs-12">
							...
							<div class="left col-sm-4">
								...
								<div class="right col-sm-8">
									...
									<div class="rating">
										...
										<span class="fa fa-stack"><i class="material-design-bookmark45 mod1 fa-stack-2x"></i></span>
										<?php } else { ?>
										<span class="fa fa-stack"><i class="material-design-bookmark45 fa-stack-2x"></i><i class="fa material-design-bookmark45 fa-stack-2x"></i></span>
										<?php } ?>
										<?php } ?>
									</div>
			...
			<div class="cart-button">
				...
				<a class="btn-mod quickview" data-rel="details" href="#quickview_<?php echo $f?>">
