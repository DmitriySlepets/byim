							...
							<div class="left col-sm-4">
								...
								<div class="right col-sm-8">
									...
									<div class="cart-button">
										<button class="btn btn-add" type="button" data-toggle="tooltip" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>'); yaCounter38314050.reachGoal('click1'); ga('send', 'event', 'Order1', 'view1');"><i class="fa fa-shopping-cart"></i></button>
