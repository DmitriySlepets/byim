...
<div class="buttons">
  <div class="pull-right">
    <input type="button" onclick="yaCounter38314050.reachGoal('click3'); ga('send', 'event', 'Order3', 'view3');" value="<?php echo $button_confirm; ?>" id="button-confirm" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary" />
  </div>
</div>
