		...
		<tbody>
		  ...
		  <tr>
			...
			<td><?php if ($products[$product['product_id']]['price']) { ?>
			  ...
			  <span class="price-old"><?php echo substr(preg_replace("/[^\d.]/", "", $products[$product['product_id']]['price']),0,-2)." (".number_format(preg_replace("/[^0-9]/", "", $products[$product['product_id']]['price']."00"), 0, '.', ' ').") бел.руб."; ?></span> <span class="price-new"><?php echo substr(preg_replace("/[^\d.]/", "", $products[$product['product_id']]['special']),0,-2)." (".number_format(preg_replace("/[^0-9]/", "", $products[$product['product_id']]['special']."00"), 0, '.', ' ').") бел.руб."; ?></span> 
			  <?php } ?>
			  <?php } ?></td>
			<?php } ?>
		  </tr>
