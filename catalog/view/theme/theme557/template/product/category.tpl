  ...
  <div class="row"><?php echo $column_left; ?>
	...
	<div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
	  ...
	  <?php switch ($_SERVER['REQUEST_URI']){
				case '/koshelki/':
					echo '<p><img src="http://sohido.by/image/koshelki.jpg" alt="Товара нет в наличии"></p>';
					break;
				case '/vmestitelnye/':
					echo '<p><img src="http://sohido.by/image/sumki.jpg" alt="Товара нет в наличии"></p>';
					break;
				case '/kompaktnye/':
					echo '<p><img src="http://sohido.by/image/sumki.jpg" alt="Товара нет в наличии"></p>';
					break;
				case '/sharfy/':
					echo '<p><img src="http://sohido.by/image/sharfy.jpg" alt="Товара нет в наличии"></p>';
					break;
				case '/rukzaki/':
					echo '<p><img src="http://sohido.by/image/rukzaki.jpg" alt="Товара нет в наличии"></p>';
					break;
	  } ?>
