			...
			<div class="<?php echo $content_right; ?> product_page-right">
				<div class="general_info product-info">
					...
					<div class="price-section">				
						...
						<span class="price-new">
                                                    <?php if (number_format(preg_replace("/[^0-9]/", "", $special."00"), 0, '.', ' ')==0){ } else {
                                                    echo substr(preg_replace("/[^\d.]/", "", $special),0,-2)." (".number_format(preg_replace("/[^0-9]/", "", $special."00"), 0, '.', ' ').") бел.руб.";} ?>
                                                </span>
						<?php if (!$special) { ?>
						<!--<span class="price-new"><?php echo $price; ?></span>-->
						<span class="price-new"><?php echo substr(preg_replace("/[^\d.]/", "", $price),0,-2)." (".number_format(preg_replace("/[^0-9]/", "", $price."00"), 0, '.', ' ').") бел.руб."; ?></span>
						<?php } else { ?>
						<!--<span class="price-old"><?php echo $price; ?></span>-->
						<span class="price-old"><?php echo substr(preg_replace("/[^\d.]/", "", $price),0,-2)." (".number_format(preg_replace("/[^0-9]/", "", $price."00"), 0, '.', ' ').") бел.руб."; ?></span>
						<?php } ?>
						<?php if ($tax) { ?>
					...
					<ul class="list-unstyled product-section">
						<?php if ($manufacturer) { ?>
						<li><?php echo $text_manufacturer; ?> <a href="<?php echo $manufacturers; ?>" rel="nofollow"><?php echo $manufacturer; ?></a></li>
						<?php } ?>
						<li><?php echo $text_model; ?> <span><?php echo $model; ?></span></li>
						<?php if ($reward) { ?>
						<li><?php echo $text_reward; ?> <span><?php echo $reward; ?></span></li>
						<?php } ?>
						<li><?php echo $text_stock; ?><span><?php if ($stock == 'Нет в наличии (товар устарел)'){
				...
				<div id="product">
					...
					<div class="form-group form-horizontal">
						...
						<button type="button" onclick="yaCounter38314050.reachGoal('click1'); ga('send', 'event', 'Order1', 'view1');" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-add"><?php echo $button_cart; ?></button>
					</div>
					...
					<div class="product-thumb transition">
						...
						<div class="caption">
							...
							<?php if ($product['price']) { ?>
								...
								<?php echo substr(preg_replace("/[^\d.]/", "", $product['price']),0,-2)." (".number_format(preg_replace("/[^0-9]/", "", $product['price']."00"), 0, '.', ' ').") бел.руб."; //echo $product['price']; ?>
								<?php } else { ?>
								<span class="price-new"><?php echo substr(preg_replace("/[^\d.]/", "", $product['special']),0,-2)." (".number_format(preg_replace("/[^0-9]/", "", $product['special']."00"), 0, '.', ' ').") бел.руб."; //echo $product['special']; ?></span> <span class="price-old"><?php echo substr(preg_replace("/[^\d.]/", "", $product['special']),0,-2)." (".number_format(preg_replace("/[^0-9]/", "", $product['special']."00"), 0, '.', ' ').") бел.руб."; //echo $product['price']; ?></span>
								<?php } ?>
								<?php if ($product['tax']) { ?>
						...
						<div class="cart-button">
							<?php if ($stock == 'Нет в наличии (товар устарел)'){ ?>
