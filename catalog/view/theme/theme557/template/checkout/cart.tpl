		  ...
		  <table class="table table-bordered">
			...
			<tbody>
			  ...
			  <tr>
				...
				<td class="text-right"><div class="price"><?php echo substr(preg_replace("/[^\d.]/", "", $product['price']),0,-2)." (".number_format(preg_replace("/[^0-9]/", "", $product['price']."00"), 0, '.', ' ').") бел.руб."; ?></div></td>
				<td class="text-right"><div class="price price-total"><?php echo substr(preg_replace("/[^\d.]/", "", $product['total']),0,-2)." (".number_format(preg_replace("/[^0-9]/", "", $product['total']."00"), 0, '.', ' ').") бел.руб."; ?></div></td>
			  </tr>
			  <?php } ?>
		...
		<div class="col-sm-4 col-sm-offset-8">
		  <table class="table table-bordered">
			...
			<tr>
			  ...
			  <td class="text-right"><div class="price"><?php echo substr(preg_replace("/[^\d.]/", "", $total['text']),0,-2)." (".number_format(preg_replace("/[^0-9]/", "", $total['text']."00"), 0, '.', ' ').") бел.руб."; ?></div></td>
			</tr>
			<?php } ?>
		  </table>
		</div>
